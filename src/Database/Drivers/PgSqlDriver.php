...
use Nette;
use function array_map, array_values, count, explode, implode, str_contains, str_replace, strtr, substr;
...
class PgSqlDriver implements Nette\Database\Driver
{
	...
	{
		return $feature === self::SupportSequence || $feature === self::SupportSchema || $feature === self::SupportDefaultValues;
	}
