...
test('formatDateTime', function () {
	...
	Assert::equal('254358000', $driver->formatDateTime(new DateTime('1978-01-23 00:00:00')));
});

test('formatDateTime', function () {
	$connection = connectToDB(['formatDateTime' => 'Y-m-d'])->getConnection();
	$driver = $connection->getDriver();
	Assert::equal('1978-01-23', $driver->formatDateTime(new DateTime('1978-01-23 00:00:00')));
});
